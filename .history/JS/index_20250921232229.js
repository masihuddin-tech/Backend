...
console.log(arr);
////In other languages: An array is a collection of similar elements (same data type, stored in contiguous memory).

////In JavaScript: An array is a special object that can hold elements of different data types in a single collection.