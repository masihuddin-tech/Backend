...
data = 80;
console.log("Value :",data," Datatype :",typeof(data));  //Number datatype
...
data = null;
console.log("Value :",data," Datatype :",typeof(data));  //Object datatype(Null kch nhi store krta h, isliye object datatype rhe)