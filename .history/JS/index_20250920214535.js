...
//  }
 ...
 ////[III]Do-while loop--(This loop executes atleast once, whether the condition is not satisfied)
//  let a = 1;
//  do{
//   console.log(a);
//   a++;
...
////[III]Using(``) Backtick(Before 1 on keyboard)
// let str3 = `My name is  
// Khan
// Masihuddin
// Assalamualaikum!!`;   
...
////[IV]Using object--(Generally we avoid using it)
