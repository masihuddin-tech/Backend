...
//Var is a function/Globally scoped scope -(Agr var function k andar initialized h, to wo function k andar hi access ho skta h, bahar nhi).
function checkFunctionScope(){
    var level = "Beginner (HaHaa!! NOOB!!)"
    console.log("Your level of Programming is: ",level)
}
// console.log(level)  (Error ayega q k function k bhr access nhi kr skte h (function scoped/Globally scoped))
checkFunctionScope()