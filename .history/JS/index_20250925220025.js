...
////1)
function sayName(fname = "Hey", lname = "Coder"){   //If no arguments are passed, then these default parameters will be automatically used in the arguments
  console.log("Your name info is :",fname,lname);
}
sayName();

////2)
function solve(value = {age:15, wt:80, ht: 120}){
  console.log("Your name info is :",value);
}
...
////Here, 'obj2' will also contain the same reference(address) as 'obj' of heap memory.(Means, both(obj,obj2) will contain the same reference(address) of heap memory) 
