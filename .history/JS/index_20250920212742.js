...
console.log(str2.substring(2));   //Returns the string starting from index position 2 till last (Bcoz ending index is not declared)
console.log(str2.substring(3,7))  //Returns the string from index 3 to 7