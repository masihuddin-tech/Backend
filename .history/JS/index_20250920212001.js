...
console.log("Legth",str1.length);   //To calculate the length(alaong with spaces)

console.log(str1.toUpperCase());  //Converts the string to Upper Case
console.log(str2.toLowerCase());  //Converts the string to Lower Case