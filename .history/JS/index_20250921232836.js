...
////1]Creation of arrays
 ////1)Normal creation
 let arr = [1,2,"Khan",true,{profession : "Software Engineer"}];    //Here,'arr' is stored at stack memory which has the reference of the heap memory, where the values[1,2,3]
 console.log(arr);
