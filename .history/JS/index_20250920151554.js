...
data = 80;
console.log("Value :",data," Datatype :",typeof(data));  //Number datatype ((It can store big integers beyond the range (-(2^53)-1 to (2^53)-1) ))
...
data = 
console.log("Value :",data," Datatype :",typeof(data));  //BigInt (It can store big integers beyond the range (-(2^53)-1 to (2^53)-1) )
