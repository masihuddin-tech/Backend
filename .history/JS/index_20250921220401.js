...
let obj2 = obj; //Here, 'obj2' will also contain the same reference(address) as 'obj' of heap memory.(Means, both(obj,obj2) will contain the same reference(address) of heap memory) 
