...
//// ***********Error handling***********
//// Types of errors
////1]Compile Time(Syntax error) - Jo error apne ko run krne se pehle hi pta chl jata h (IDE/Code Editor me red mark ajata h)
//// console.log(1;

////2]Runtime error(Reference error) - Jo error k